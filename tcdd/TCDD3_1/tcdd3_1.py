...
class TCDD3_1(TestCase):
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            ...
            TestStep(
                "Test Step 5.4.6.1: Commissioner arms Fail-safe timer on the Commissionee using ArmFailSafe command"),
            TestStep("Test Step 5.4.6.1: Commissioner SHALL configure at the Commissionee UTC time, timezone, DST offset, and regulatory information at the Commissionee."),
            TestStep(
                "Test Step 5.4.6.1: Commissioner establishes the authenticity of the Commissionee as a certified CHIP device."),
            TestStep(
                "Test Step 5.4.6.1: Commissioner configures Fabric information using SetFabric command."),
            TestStep(
                "Test Step 5.4.6.1: Commissioner requests operational CSR from Commissionee with OperationalCSRRequest command"),
            ...
            TestStep(
                "Test Step 5.4.6.1: Commissioner configures operational credentials"),
            TestStep("Test Step 5.4.6.1: Commissioner configures ACL."),
            TestStep(
                "Test Step 5.4.6.1: Commissioner configures the operational network at the Commissionee."),
            TestStep(
                "Test Step 5.4.6.1: Commissioner triggers the Commissionee to connect to the operational network"),
            ...
            TestStep(
                "Test Step 5.4.6.1: Commissioner and Commissionee establish encryption keys with CASE"),
            ...
            TestStep(
                "Test Step 5.4.6.1: Same steps as 1.a-1.o. Force Fail any step between 1.a and 1.j."),
            TestStep(
                "Test Step 5.4.6.1: Same steps as 1.a. Force Fail any step between 1.k and 1.o"),
        ]
    ...
    async def execute(self) -> None:
        ...
        # 5.4.6.1: Commissioner SHALL configure at the Commissionee UTC time, timezone, DST offset, and regulatory information at the Commissionee.
        ...
        # 1) for validation steps
        #
        logger.info("5.4.6.1: Commissioner SHALL configure at the Commissionee UTC time, timezone, DST offset, and regulatory information at the Commissionee.")
        self.next_step()
        ...
        # 5.4.6.1: Same steps as 1.a-1.o. Force Fail any step between 1.a and 1.j.
        ...
        # 5.4.6.1: Same steps as 1.a. Force Fail any step between 1.k and 1.o
        # Commissioner and Commissionee returning to 1
        # k (configuration of operational network information) and continue the commissioning flow again
        #
        logger.info(
            "5.4.6.1: Same steps as 1.a. Force Fail any step between 1.k and 1.o")
        self.next_step()
