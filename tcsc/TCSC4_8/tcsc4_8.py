...
class TCSC4_8(TestCase):
    ...
    def create_test_steps(self) -> None:
        self.test_steps = [
            TestStep(
                "Test Step TH: TH is instructed to start advertising its presence as a commissioner in the network"),
            TestStep(
                "Test Step 4.2.3-1 DUT: Scan for DNS-SD commissioner advertisements from TH"),
            TestStep(
                "Test Step TH: By any means, TH adds an unknown key/value pair in the advertised data(e.g. AB=12345)"),
        ]
    ...
    async def execute(self) -> None:
        # TH: TH is instructed to start advertising its presence as a commissioner in the network
        # no desc
        logger.info(
            "TH: TH is instructed to start advertising its presence as a commissioner in the network")
        self.next_step()

        # 4.2.3-1 DUT: Scan for DNS-SD commissioner advertisements from TH
        ...
        # TH: By any means, TH adds an unknown key/value pair in the advertised data(e.g. AB=12345)
